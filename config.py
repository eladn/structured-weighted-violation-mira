...
class Config:
    ...
    mira_k_best_viterbi_labelings = 1
    mira_iterations = 5
    ...
    def model_name(self):
        ...
        self.__model_name = "{model_type}__k-rnd={k_rnd}__k-viterbi={k_viterbi}__iter={iter}__loss={loss}__train-set={data_filename}__{data_hash}".format(
